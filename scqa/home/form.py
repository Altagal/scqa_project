...
exclude_softdelete_fields = ["created_at", "deleted_at", "restored_at", "transaction_id", "modified_at",
                             "modified_by", ]


class ScqaModelForm(ModelForm):
    ...
    def __init__(self, *args, readonly=None, **kwargs, ):
        ...
        for visible in self.visible_fields():
            ...
            if __first_loop:
                __first_loop = False
                # Execução no primeiro laço (renderização do primeiro form/input).
